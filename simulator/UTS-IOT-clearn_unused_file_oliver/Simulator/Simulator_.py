...
class Simulator:
	...
	def generateUsers(self):
		...
		print("Please enter percentage of user have PVs")
		percentage = input ("Percentage -> ")
		percentageInUse = float(percentage)/float(100.00)
		NoInUse = int(self.totalNoUsers) * float(percentageInUse) #number of prosumers
		idx = 0
		while idx < int(self.totalNoUsers):
			if(idx < NoInUse):
